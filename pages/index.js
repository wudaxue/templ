  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.tip}>欢迎您访问我们的产品。Gitlab issue management 是由 北京阿特普洛科技有限公司 （以下简称“我们”）开发并运营的。 确保用户的数据安全和隐私保护是我们的首要任务， 本隐私政策载明了您访问和使用我们的产品和服务时所收集的数据及其处理方式。</div>
        <div className={styles.tip}>请您在继续使用我们的产品前务必认真仔细阅读并确认充分理解本隐私政策全部规则和要点， 一旦您选择使用，即视为您同意本隐私政策的全部内容，同意我们按其收集和使用您的相关信息。  如您不同意相关协议或其中的任何条款的，您应停止使用我们的产品和服务。</div>
          {/* <div className={styles.tip}>请您在继续使用我们的产品前务必认真仔细阅读并确认充分理解本隐私政策全部规则和要点， 一旦您选择使用，即视为您同意本隐私政策的全部内容，同意我们按其收集和使用您的相关信息。 如您在在阅读过程中，对本政策有任何疑问，可联系我们的客服咨询， 请通过 wudaxue123@gmail.com 或产品中的反馈方式与我们取得联系。 如您不同意相关协议或其中的任何条款的，您应停止使用我们的产品和服务。</div> */}
        ...
        <div className={styles.content}>
          ...
          <div className={styles.item}>
            ...
            <div className={styles.info}>
              为接受我们全面的产品服务，您应首先注册一个用户账号，我们将通过它记录相关的数据。 您所提供的所有信息均来自于您本人在注册时提供的数据。 您准备使用的gitlab相关信息。
            </div>
          </div>
          <div className={styles.item}>
            <div className={styles.itemTitle}>二、我们如何存储和保护您的个人信息 </div>
            <div className={styles.info}>
          ...
          <div className={styles.item}>
            <div className={styles.itemTitle}> 三、我们如何共享、转让、公开披露您的个人信息</div>
            <div className={styles.info}>
          ...
          <div className={styles.item}>
            <div className={styles.itemTitle}>四、我们如何使用  Cookie 和其他追踪技术<div>
            <div className={styles.info}>
